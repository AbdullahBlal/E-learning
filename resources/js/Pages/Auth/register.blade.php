                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="col-md-12 mb-3">
                            <select class="form-select @error('educational_level_id') is-invalid @enderror" name="educational_level_id">
                        ...
                        <div class="row mb-3">
                            <label for="coupon" class="col-md-4 col-form-label text-md-end">{{ __('Student Coupon') }}</label>

                            <div class="col-md-6">
                                <input id="coupon" type="text" class="form-control @error('coupon') is-invalid @enderror" name="coupon" required autocomplete="coupon">
